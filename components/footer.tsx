...
const links = [
  ...
  },
  {
    group: "Archives",
    items: [
      { title: "Past Issues", href: "/archives/issues" },
  ...
  {
    group: "Guidelines",
    items: [{ title: "Submission Guidelines", href: "/guidelines" }],
  },
  {
    group: "Contact",
    ...
    <footer className="border-b bg-white pt-20 dark:bg-transparent">
      <div className="mb-8 border-b md:mb-12">
        <div className="mx-auto flex max-w-5xl flex-wrap items-end justify-between gap-6 px-6 pb-6">
          <Link href="/" aria-label="go home" className="block size-fit font-bold text-2xl">
            MACROJ
          </Link>
